...
class StoriesProgressView @JvmOverloads constructor(
    ...
    @ColorInt
    private var backgroundProgress: Int = 0

    @ColorInt
    private var backgroundInProgress: Int = 0

    @ColorInt
    private var backgroundMaxProgress: Int = 0
    ...
    init {
        ...
        backgroundProgress = typedArray.getColor(R.styleable.StoriesProgressView_backgroundProgress, 0)
        backgroundInProgress = typedArray.getColor(R.styleable.StoriesProgressView_backgroundInProgress, 0)
        backgroundMaxProgress = typedArray.getColor(R.styleable.StoriesProgressView_backgroundMaxProgress, 0)
    ...
    private fun createProgressBar(): PausableProgressBar {
        return PausableProgressBar(context).apply {
            ...
            backgroundProgress = this@StoriesProgressView.backgroundMaxProgress
            backgroundInProgress = this@StoriesProgressView.backgroundInProgress
            backgroundMaxProgress = this@StoriesProgressView.backgroundMaxProgress
            setBackGround()
        }
    }
